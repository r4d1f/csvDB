...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.listWidget.setGeometry(QtCore.QRect(9, 9, 532, 251))
        ...
        self.btnBrowse.setGeometry(QtCore.QRect(200, 273, 341, 31))
        self.btnBrowse.setIconSize(QtCore.QSize(16, 16))
        self.btnBrowse.setObjectName("btnBrowse")
        self.btnAddToDB = QtWidgets.QPushButton(self.centralwidget)
        self.btnAddToDB.setGeometry(QtCore.QRect(200, 314, 341, 31))
        ...
        self.btnLvl = QtWidgets.QPushButton(self.centralwidget)
        self.btnLvl.setGeometry(QtCore.QRect(9, 273, 150, 23))
        self.btnLvl.setObjectName("btnLvl")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnLvl.setText(_translate("MainWindow", "Уровень образования"))
